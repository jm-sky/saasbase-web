...
const emit = defineEmits<{
  download: [attachment: IExpenseAttachment]
  delete: [attachment: IExpenseAttachment]
}>()
</script>

<template>
  <div class="grid grid-cols-[1fr_auto] md:grid-cols-[1fr_1fr_1fr_1fr_auto] gap-2 items-center px-3 py-2 text-sm border rounded-md max-w-full">
