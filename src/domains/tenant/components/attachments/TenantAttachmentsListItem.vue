...
import { type ITenantAttachment } from '@/domains/tenant/services/TenantAttachmentsService'

const { t } = useI18n()

defineProps<{
  attachment: ITenantAttachment
  tenantId: string
}>()

const emit = defineEmits<{
  download: [attachment: ITenantAttachment]
  delete: [attachment: ITenantAttachment]
}>()
</script>
