...
const tabs = computed(() => [
  {
    to: `/tenants/${tenantId}/financial-settings/numbering-templates`,
    label: t('invoice.numberingTemplate.title'),
  },
  {
    to: `/tenants/${tenantId}/financial-settings/invoice-templates`,
