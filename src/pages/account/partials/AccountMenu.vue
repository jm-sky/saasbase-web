...
const navigationSections = [
  ...
  },
  {
    ...
    items: [
      { name: 'Email', path: '/account/auth/email', icon: 'heroicons:envelope' },
      { name: 'Social Sign in', path: '/account/auth/social', icon: 'heroicons:user-group' },
      { name: 'Two-Factor auth(2FA)', path: '/account/auth/2fa', icon: 'heroicons:shield-check' },
      { name: 'Single Sign On(SSO)', path: '/account/auth/sso', icon: 'heroicons:key' },
      { name: 'Password', path: '/account/auth/password', icon: 'heroicons:lock-closed' },
    ]
  },
  {
    title: 'Advanced Settings',
    items: [
      { name: 'Preferences', path: '/account/preferences', icon: 'heroicons:cog' },
      ...
      { name: 'Address', path: '/account/address', icon: 'heroicons:map-pin' },
    ]
  },
  {
    ...
    items: [
      ...
      { name: 'Integrations', path: '/account/integrations', icon: 'heroicons:puzzle-piece' },
    ]
  },
  {
    title: 'Account',
    items: [
      ...
      { name: 'Delete Account', path: '/account/delete', icon: 'heroicons:trash' },
    ]
  }
]
</script>
