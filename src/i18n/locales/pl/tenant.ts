export const tenant = {
  ...
  invoiceTemplates: {
    ...
    editor: {
      ...
      error: 'błąd | błędów',
      valid: 'Poprawny',
      templateErrors: 'Błędy szablonu',
      line: 'Linia',
      availablePaths: 'Dostępne ścieżki schematu',
      handlebarsHelpers: 'Pomocniki Handlebars',
      basicInvoice: 'Podstawowa faktura',
      simpleInvoice: 'Prosta faktura tekstowa',
      translationHelper: 'Pomocnik tłumaczeń dla i18n',
      formatCurrency: 'Formatuj walutę z symbolem',
      formatDate: 'Formatuj datę z niestandardowym formatem',
      formatNumber: 'Formatuj liczbę z miejscami dziesiętnymi',
      upperCase: 'Konwertuj tekst na wielkie litery',
      lowerCase: 'Konwertuj tekst na małe litery',
      ifEquals: 'Warunkowo jeśli wartości są równe',
      ifNotEmpty: 'Warunkowo jeśli wartość nie jest pusta',
      logoUrl: 'Renderuj logo z określoną szerokością',
      signatureUrl: 'Renderuj obraz podpisu',
      each: 'Iteruj przez tablice',
      if: 'Renderowanie warunkowe',
      unless: 'Negatywne renderowanie warunkowe',
      propertyNotExist: 'Właściwość \'{path}\' nie istnieje w schemacie',
    },
    helper: {
