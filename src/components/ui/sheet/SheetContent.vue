...
<template>
  <DialogPortal>
    ...
    <DialogContent
      ...
      :class="cn(
        'm-2 rounded-lg bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-400',
        side === 'right'
